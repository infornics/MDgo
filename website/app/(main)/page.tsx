  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/doc">
              <Button
                variant="outline"
                size="sm"
                className="hidden sm:flex text-xs rounded-full group bg-background/50"
              >
      ...
      <section className="relative pt-24 md:pt-40 pb-16 md:pb-20 px-4 md:px-6 overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[300px] md:w-[400px] h-[300px] md:h-[400px] bg-foreground/5 blur-[100px] -z-10 rounded-full opacity-30 animate-pulse" />

        <div className="max-w-4xl mx-auto text-center space-y-8">
          <Link
            href="https://infornics.com/marketplace"
            target="_blank"
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-muted/50 text-[10px] uppercase tracking-widest font-bold text-primary animate-in fade-in slide-in-from-bottom-2 duration-700"
          >
            Built By Infornics
          </Link>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            <Link href="/doc">
              <Button
                size="lg"
                className="h-12 px-10 rounded-xl font-bold text-sm bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95"
              >
                Start Writing Now
              </Button>
            </Link>
            <a href="https://github.com/infornics/MDgo" target="_blank">
              <Button
                size="lg"
                variant="outline"
                className="h-12 px-8 rounded-xl font-bold text-sm bg-background border-border hover:bg-muted transition-all"
              >
        ...
        <div className="max-w-6xl mx-auto mt-24 relative animate-in fade-in zoom-in duration-1000 delay-500">
          <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 via-foreground/5 to-primary/20 rounded-[2rem] blur-2xl opacity-50" />
          <div className="relative rounded-[1.5rem] border border-border bg-card shadow-2xl overflow-hidden aspect-[16/9]">
            {/* Window Header */}
            <div className="h-10 border-b border-border/50 flex items-center px-4 gap-2 bg-muted/50">
              ...
              <div className="flex-1 flex justify-center">
                <div className="h-5 w-40 bg-foreground/5 rounded-md" />
              </div>
            </div>
            {/* Editor Content Area */}
            <div className="flex h-full flex-col md:flex-row">
              <div className="w-full md:w-1/2 h-full border-b md:border-b-0 md:border-r border-border/50 p-4 md:p-6 space-y-4">
                <div className="h-6 w-3/4 bg-primary/10 rounded-md" />
                <div className="h-4 w-full bg-muted-foreground/10 rounded-sm" />
                <div className="h-4 w-5/6 bg-muted-foreground/10 rounded-sm" />
                <div className="hidden md:block h-32 w-full bg-muted-foreground/10 rounded-sm" />
                <div className="h-4 w-full bg-muted-foreground/10 rounded-sm" />
              </div>
              <div className="w-full md:w-1/2 h-full p-4 md:p-6 space-y-4 md:space-y-6">
                <div className="h-10 w-1/2 bg-muted-foreground/10 rounded-md" />
                <div className="space-y-3">
                  <div className="h-4 w-full bg-muted-foreground/10 rounded-sm" />
                  <div className="h-4 w-full bg-muted-foreground/10 rounded-sm" />
                  <div className="h-4 w-2/3 bg-muted-foreground/10 rounded-sm" />
                </div>
                <div className="h-24 md:h-40 w-full bg-muted/20 border border-border/50 rounded-lg" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Stats/Badges */}
      <section className="py-8 md:py-12 border-y border-border/40 bg-muted/20">
      ...
      {/* Infornics Section */}
      <section className="py-16 md:py-24 px-4 md:px-6 border-t border-border/40 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-primary/5 blur-[150px] -z-10 rounded-full" />

        <div className="max-w-4xl mx-auto bg-gradient-to-b from-muted/50 to-transparent border border-border/50 rounded-[2rem] md:rounded-[3rem] p-6 md:p-12 text-center space-y-6 md:space-y-8">
          <div className="h-12 w-12 md:h-16 md:w-16 bg-foreground text-background flex items-center justify-center rounded-xl md:rounded-2xl mx-auto shadow-xl">
            <span className="font-black text-xl md:text-2xl italic">I</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 md:gap-10">
          ...
          <div className="flex items-center gap-6">
            <a
              href="https://github.com/infornics/MDgo"
              target="_blank"
              className="h-9 w-9 md:h-10 md:w-10 rounded-full border border-border flex items-center justify-center hover:bg-muted transition-all"
            >
...
function FeatureCard({
  ...
  return (
    <div className="p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border border-border/40 bg-card hover:bg-accent/40 hover:border-border transition-all group">
      <div className="mb-4 md:mb-6 p-3 md:p-4 rounded-xl md:rounded-2xl bg-muted/40 w-fit shadow-inner group-hover:scale-110 transition-transform">
        {icon}
      </div>
