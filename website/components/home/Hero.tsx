  ...
  return (
    <section className="relative pt-32 md:pt-48 pb-16 md:pb-24 px-4 md:px-6 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
        ...
        <p className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tight leading-none md:leading-[0.9] animate-in fade-in slide-in-from-bottom-4 duration-1000 drop-shadow-sm font-outfit">
          Write. Preview. <br />
        ...
        <p className="text-lg md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200 font-medium">
          The premium markdown experience. Real-time rendering, granular sharing
          permissions, and high-fidelity PDF exports.
        </p>
              ...
              <div className="flex gap-3 opacity-90">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span>
                      Optimize{" "}
                      <span className="text-green-500">`rendering_engine`</span>
                    </span>
                  </div>
                  <br />
                  <div className="flex gap-2">
